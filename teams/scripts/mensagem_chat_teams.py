import requests
from scripts.dados_para_mensagem import dados_projetos, dados_macroentregas
                ...
                "columns": [
                    {
                        ...
                        "items": [
                            ...
                            *[
                                ...
                                for _, row in macro_sem_termo_60.iterrows()
                            ]
                        ]
                    },
                    {
                ...
                "columns": [
                    ...
                    },
                    {
                        ...
                        "items": [
                            ...
                            # Adicionando os TextBlocks para cada código de projeto
                            *[
                                {"type": "TextBlock", "text": truncate_text(str(row["modalidade"]), max_length=10), "wrap": True, "horizontalAlignment": "Left"}
                                for _, row in novos.iterrows()
                            ]
                        ]
                    }
                ...
                "columns": [
                    ...
                    },
                    {
                        ...
                        "items": [
                            ...
                            # Adicionando os TextBlocks para cada código de projeto
                            *[
                                {"type": "TextBlock", "text": str(row["data_termino"]), "wrap": True, "horizontalAlignment": "Left"}
                                for _, row in novos2.iterrows()
                            ]
                        ]
                    },
            ...
            column_set_macro_atrasadas = {
                ...
                "columns": [
                    ...
                    },
                    {
                        ...
                        "width": "auto",
                        "items": [
                            {"type": "TextBlock", "text": "Data de término plan.", "weight": "Bolder", "size": "Medium", "color": "accent", "wrap": True, "horizontalAlignment": "Left"},
                            # Adicionando os TextBlocks para cada código de projeto
                            *[
                                {"type": "TextBlock", "text": str(row["data_termino_planejada"]), "wrap": True, "horizontalAlignment": "Left"}
                                for _, row in novas_macro.iterrows()
                            ]
                        ]
                    },
                    ...
                    "content": {
                        ...
                        "body": [
...

                            {
                                ...
                                "wrap": True,
                                "items": [
                                    { "type": "TextBlock", "text": "📌 **Macroentregas sem Termo**", "size": "Large", "weight": "Bolder" },
...
def enviar_mensagem_teams(payload):
    """
