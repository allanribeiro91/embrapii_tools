...
def comparar_status(df_hoje, df_anterior, nome_status, status_desejado, colunas_interesse, coluna_arrange=None, macro=False):
    ...
    try:
        ...
        if macro:
            ...
            # Cria conjuntos com base no 'codigo_projeto' e outras colunas de interesse
...
def verificar_status_macroentrega(df_macro, df_portfolio):
    """
    ...
    try:
        ...
        if "SEBRAE" in modalidade_financiamento:
            if "BNDES" in modalidade_financiamento:
                resultado = "Sebrae e BNDES"
            elif "ROTA" in modalidade_financiamento:
                resultado = "Sebrae e ROTA"
            elif "EMBRAPII" in modalidade_financiamento:
                resultado = "Sebrae e Embrapii CG"
            else:
                resultado = "Sebrae"

        elif "BNDES" in modalidade_financiamento:
            if "ROTA" in modalidade_financiamento:
                resultado = "BNDES e Rota 2030"
            elif "EMBRAPII" in modalidade_financiamento:
                resultado = "BNDES e Embrapii CG"
            else:
                resultado = "BNDES"
        ...
        elif "BAMBU" in modalidade_financiamento:
            resultado = "Bambu"

        else:
            resultado = "Embrapii CG"
...
def dados_projetos():
    ...
    try:
        ...
        novos, proj_concluidos, novos_concluidos = comparar_status(projetos_atual, projetos_anterior,
                                                                ...
                                                                ['unidade_embrapii', 'codigo_projeto', 'modalidade'],
